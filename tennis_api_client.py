...
def get_event_details(player1, player2, date_only):
    """
    Full match detail by player names + date: score, per-player stats
    (aces, double faults, serve/return %), and a timeline of match events.
    date_only: 'YYYY-MM-DD'
    """
    return _get(f"/extend/api/event/get/{player1}/{player2}/{date_only}")
